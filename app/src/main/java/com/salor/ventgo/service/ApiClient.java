...
public class ApiClient {
    public static ApiInterface getClient() {
        Retrofit retrofit = provideRetrofit(provideGson(), provideOkhttpClient(provideRequestInterceptor()));
    ...
    public static Gson provideGson() {
        ...
        gsonBuilder.setDateFormat(Cons.DateFormat);
        return gsonBuilder.create();
    }

    private static EncryptionApi provideRequestInterceptor() {
        return new EncryptionApi();
    }

    private static OkHttpClient provideOkhttpClient(final EncryptionApi encryptionApi) {
