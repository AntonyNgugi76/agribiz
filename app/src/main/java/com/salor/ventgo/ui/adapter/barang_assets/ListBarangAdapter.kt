...
class ListBarangAdapter(private val context: Activity, private val item_homes: List<BarangAssets>,var listActivity : ListBarangActivity) : RecyclerView.Adapter<ListBarangAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.tvQty.text = "KES "+item.stock
